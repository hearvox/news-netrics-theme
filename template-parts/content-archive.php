...
$pub_circ  = ( isset( $custom_fields['nn_pub_circ_ep'][0] ) )
	? ' <span style="font-size: 0.8rem;">(<em>Circ.:</em> ' . number_format( floatval( $custom_fields['nn_pub_circ_ep'][0] ) ) . ')</span>' : '';
...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'clear' ); ?> style="border-top: 1px solid #c9cdda;">
	<header class="entry-header">
		...
		<strong><?php echo $pub_name; ?></strong> <em><?php echo $pub_circ; ?></em>
